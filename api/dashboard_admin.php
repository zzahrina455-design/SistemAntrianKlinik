...
// Proteksi halaman: Jika belum login atau bukan admin, kembali ke login
                ...
                <?php if (isset($_GET['pesan'])): ?>
                    ...
                    <?php elseif ($_GET['pesan'] == 'update_sukses'): ?>
                        <div class="alert alert-success alert-dismissible fade show" role="alert">
                            Status pasien berhasil diperbarui menjadi selesai!
                            <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                    ...
                                    <?php while ($row = mysqli_fetch_assoc($result_data)): ?>
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <?php if ($row['status'] == 'Menunggu'): ?>
                                                    <a href="proses_selesai.php?id=<?php echo $row['id']; ?>"
                                                       class="btn btn-sm btn-primary rounded-pill px-3 shadow-sm mb-1"
                                                       onclick="return confirm('Konfirmasi: Tandai pasien ini selesai diperiksa?');">
                                                ...
                                                <a href="proses_hapus.php?id=<?php echo $row['id']; ?>"
                                                   ...
                                                   onclick="return confirm('Peringatan: Yakin ingin menghapus antrian ini secara permanen?');">
                                ...
                                <?php else: ?>
                                    <tr>
                                        <td colspan="6" class="text-center py-4 text-muted">Belum ada data antrian pasien terdaftar.</td>
                                    </tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
